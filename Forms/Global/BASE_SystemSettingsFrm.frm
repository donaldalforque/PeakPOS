...
Begin VB.Form BASE_SystemSettingsFrm 
   ...
   Begin VB.Frame FRE_Inventory 
      ...
      Begin VB.Label Label14 
         BackStyle       =   0  'Transparent
         Caption         =   "Removes expired product information."
         BeginProperty Font 
            Name            =   "Calibri"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame FRE_Main 
      ...
      Begin VB.Frame FRE_Sales 
         ...
         Begin VB.Label Label32 
            BackStyle       =   0  'Transparent
            Caption         =   "# of print out copies of receipt using POS for accounts."
            BeginProperty Font 
               Name            =   "Calibri"
               Size            =   9
               Charset         =   0
      ...
      Begin VB.Frame FRE_POS 
         ...
         Begin VB.CommandButton btnShrinkages 
            ...
            Width           =   2175
         End
         Begin VB.CommandButton btnSalesman 
            Appearance      =   0  'Flat
            Caption         =   "Salesman"
            BeginProperty Font 
               Name            =   "Calibri"
            ...
            Width           =   2175
         End
         Begin VB.CommandButton btnDiscounts 
            Appearance      =   0  'Flat
            Caption         =   "Discounts"
            BeginProperty Font 
               Name            =   "Calibri"
...
Private Sub btnDiscounts_Click()
...
Private Sub btnSalesOrder_Click()
    ...
    txtPrintOut.Text = POS_SO_PrintOutCopies
End Sub
...
Private Sub btnSave_Click()
    ...
    cmd.ActiveConnection = con
    cmd.CommandType = adCmdStoredProc
    If optInterestEnable.value = True Then
        cmd.Parameters.Append cmd.CreateParameter("@EnableInterest", adBoolean, adParamInput, , True)
        EnableInterest = True
    Else
        cmd.Parameters.Append cmd.CreateParameter("@EnableInterest", adBoolean, adParamInput, , False)
        EnableInterest = False
    End If
    cmd.Parameters.Append cmd.CreateParameter("@PrintOutCopies", adInteger, adParamInput, , NVAL(txtPrintOut.Text))
    cmd.CommandText = "SO_Settings_Update"
    cmd.Execute
    con.Close
...
Private Sub btnUnits_Click()
    BASE_LoyaltyCardSettingsFrm.Show (1)
End Sub
...
Private Sub Command9_Click()
    x = MsgBox("Are you sure you want to remove expired product information?", vbQuestion + vbYesNo)
    If x = vbYes Then
        Dim con As New ADODB.Connection
        con.ConnectionString = ConnString
        con.Open
        ...
        cmd.ActiveConnection = con
        cmd.CommandType = adCmdStoredProc
        cmd.CommandText = "INV_ProductExpiry_RemoveExpired"
        cmd.Execute
        con.Close
        
        MsgBox "Expired product record information removed successfully!", vbInformation
    End If
End Sub
...
Private Sub txtPrintOut_Change()
    If IsNumeric(txtPrintOut.Text) = False Then txtPrintOut.Text = "1"
End Sub
