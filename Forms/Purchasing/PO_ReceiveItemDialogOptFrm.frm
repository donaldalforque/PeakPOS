VERSION 5.00
Begin VB.Form PO_ReceiveItemOptFrm 
   ...
   End
End
Attribute VB_Name = "PO_ReceiveItemOptFrm"
...
Private Sub cmbUnit_Click()
    ...
    Else
        GetProductConversion PO_ReceiveOrderFrm.lvItems.SelectedItem.SubItems(9), cmbUnit.ItemData(cmbUnit.ListIndex), "Cost"
    End If
End Sub
...
Private Sub Form_Load()
    ...
    If isModify = True Then
        cmd.Parameters.Append cmd.CreateParameter("@ProductId", adInteger, adParamInput, , PO_ReceiveOrderFrm.lvItems.SelectedItem.SubItems(6))
    Else
