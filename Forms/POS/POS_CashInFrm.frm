...
Begin VB.Form POS_CashInFrm 
   ...
   Begin VB.CommandButton btnCancel 
      ...
      Height          =   850
      Left            =   3840
      Picture         =   "POS_CashInFrm.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   3240
      Width           =   1575
   ...
   Begin VB.CommandButton btnAccept 
      ...
      Height          =   850
      Left            =   2160
      Picture         =   "POS_CashInFrm.frx":238F
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3240
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "POS_CashInFrm"
...
Private Sub btnAccept_Click()
    ...
    If x = vbYes Then
        ...
        cmd.Parameters.Append cmd.CreateParameter("@Type", adVarChar, adParamInput, 250, "CASH-IN")
        ...
        MsgBox "Cash-in successful!", vbInformation
        Unload Me
    End If
End Sub
