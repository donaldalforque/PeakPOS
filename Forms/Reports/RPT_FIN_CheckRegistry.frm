...
Begin VB.Form RPT_FIN_CheckRegistryFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_FIN_CheckRegistry.frx":0000
         Left            =   1320
         List            =   "RPT_FIN_CheckRegistry.frx":000D
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_FIN_CheckRegistry.frx":003A
         Left            =   1320
         List            =   "RPT_FIN_CheckRegistry.frx":004A
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   3120
         Width           =   2415
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\FIN_CheckRegistry.rpt")
