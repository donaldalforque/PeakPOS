...
Begin VB.Form RPT_SO_SalesByProductDetailsFrm 
   Caption         =   "Sales Order by Product Details"
   ClientHeight    =   9015
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbGroup 
         ...
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":000D
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":0028
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":002A
         Style           =   2  'Dropdown List
         TabIndex        =   11
         Top             =   1440
         Width           =   2415
      ...
      Begin VB.ComboBox cmbCategory 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":002C
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":002E
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   1080
         Width           =   2415
      ...
      Begin VB.ComboBox cmbProduct 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":0030
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":0032
         TabIndex        =   7
         Top             =   720
         Width           =   2415
      End
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesByProductDetailsFrm.frx":0034
         Left            =   1320
         List            =   "RPT_SO_SalesByProductDetailsFrm.frx":0042
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   4800
         Width           =   2415
...
Private Sub btnGenerate_Click()
    ...
    Select Case cmbGroup.ListIndex
        Case 0 ' normal
            Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\SO_SalesOrderByProduct.rpt")
        Case 1 ' supplier
    ...
    If cmbCategory.text = "" Then
        crxRpt.ParameterFields.GetItemByName("Category").AddCurrentValue "All"
    Else
