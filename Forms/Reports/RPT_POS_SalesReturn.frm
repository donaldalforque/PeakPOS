...
Begin VB.Form RPT_POS_SalesReturn 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbCashier 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_POS_SalesReturn.frx":0000
         Left            =   1320
         List            =   "RPT_POS_SalesReturn.frx":0002
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_POS_SalesReturn.frx":0004
         Left            =   1320
         List            =   "RPT_POS_SalesReturn.frx":000F
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   4080
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_POS_SalesReturn"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\POS_SalesReturn.rpt")
