...
Begin VB.Form RPT_PO_SupplierStatementofAccountFrm 
   Caption         =   "Supplier Statement of Account"
   ClientHeight    =   9015
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_PO_SupplierStatementofAccountFrm.frx":0000
         Left            =   1320
         List            =   "RPT_PO_SupplierStatementofAccountFrm.frx":000A
         TabIndex        =   3
         Text            =   "cmbCustomer"
         Top             =   960
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_PO_SupplierStatementofAccountFrm"
            ...
            If Not rec.EOF Then
                Do Until rec.EOF
                    If rec!isActive = "True" Then
                        ...
                        cmbCustomer.ItemData(cmbCustomer.NewIndex) = rec!VendorId
                    End If
                    rec.MoveNext
                Loop
            End If
...
Private Sub btnGenerate_Click()
    If cmbCustomer.ListIndex = -1 Then
        MsgBox "Please select a valid supplier.", vbExclamation, "Required."
        Exit Sub
    End If
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\PO_SupplierStatement.rpt")
    crxRpt.EnableParameterPrompting = False
    crxRpt.DiscardSavedData
    Call ResetRptDB(crxRpt)
          
    crxRpt.ParameterFields.GetItemByName("ReportTitle").AddCurrentValue txtTitle.text
    crxRpt.ParameterFields.GetItemByName("@VendorId").AddCurrentValue cmbCustomer.ItemData(cmbCustomer.ListIndex)
