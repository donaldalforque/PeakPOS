...
Begin VB.Form RPT_SO_SalesAdjustmentSummaryFrm 
   Caption         =   "Sales Adjustment Summary"
   ClientHeight    =   9015
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesAdjustmentSummaryFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SO_SalesAdjustmentSummaryFrm.frx":000D
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesAdjustmentSummaryFrm.frx":0022
         Left            =   1320
         List            =   "RPT_SO_SalesAdjustmentSummaryFrm.frx":002C
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   720
         Width           =   2415
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_SalesAdjustmentSummaryFrm.frx":0051
         Left            =   1320
         List            =   "RPT_SO_SalesAdjustmentSummaryFrm.frx":0064
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   3360
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_SO_SalesAdjustmentSummaryFrm"
...
Private Sub btnGenerate_Click()
    ...
    crxRpt.ParameterFields.GetItemByName("@Type").AddCurrentValue cmbType.Text
