...
Begin VB.Form RPT_SO_CustomerPaymentDetailsFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbStatus 
         ...
         Left            =   1320
         List            =   "RPT_SO_CustomerPaymentDetailsFrm.frx":000A
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CustomerPaymentDetailsFrm.frx":002F
         Left            =   1320
         List            =   "RPT_SO_CustomerPaymentDetailsFrm.frx":0045
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   5400
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CustomerPaymentDetailsFrm.frx":0080
         Left            =   1320
         List            =   "RPT_SO_CustomerPaymentDetailsFrm.frx":008A
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   600
         Width           =   2415
      ...
      Begin MSComCtl2.DTPicker DateFrom 
         ...
         CurrentDate     =   41686
      End
      Begin MSComCtl2.DTPicker dtCheckTo 
         Height          =   345
         Left            =   1320
         TabIndex        =   19
         Top             =   3360
         ...
         CurrentDate     =   41686
      End
      Begin MSComCtl2.DTPicker dtCheckFrom 
         Height          =   345
         Left            =   1320
         TabIndex        =   20
         Top             =   3000
...
Public Sub btnGenerate_Click()
    ...
    'Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\RPT_SO_CustomerPaymentDetails.rpt")
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\SO_PaymentHistory.rpt")
    ...
    crxRpt.ParameterFields.GetItemByName("@CustomerId").AddCurrentValue Val(cmbCustomer.ItemData(cmbCustomer.ListIndex))
    crxRpt.ParameterFields.GetItemByName("@StatusId").AddCurrentValue Val(cmbStatus.ItemData(cmbStatus.ListIndex))
    ...
    crxRpt.ParameterFields.GetItemByName("@CheckDateFrom").AddCurrentValue dtCheckFrom.value
    crxRpt.ParameterFields.GetItemByName("@CheckDateTo").AddCurrentValue dtCheckTo.value
    crxRpt.ParameterFields.GetItemByName("@CheckNumber").AddCurrentValue txtCheckNumber.text
    crxRpt.ParameterFields.GetItemByName("@IssuingBank").AddCurrentValue txtIssuingBank.text
...
Private Sub DateFrom_Change()
    dtCheckFrom.value = DateFrom.value
End Sub

Private Sub DateFrom_Click()
    dtCheckFrom.value = DateFrom.value
End Sub

Private Sub DateTo_Change()
    dtCheckTo.value = DateTo.value
End Sub
...
Private Sub Form_Load()
    ...
    dtCheckFrom.value = Format(Now, "MM/DD/YY")
    dtCheckTo.value = Format(Now, "MM/DD/YY")
