...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\FIN_ExpensesReport.rpt")
    ...
    crxRpt.ParameterFields.GetItemByName("@ExpenseId").AddCurrentValue cmbExpense.ItemData(cmbExpense.ListIndex)
