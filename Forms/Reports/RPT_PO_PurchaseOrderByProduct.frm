...
Begin VB.Form RPT_PO_PurchaseOrderByProductFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_PO_PurchaseOrderByProduct.frx":0000
         Left            =   1320
         List            =   "RPT_PO_PurchaseOrderByProduct.frx":000E
      ...
      Begin VB.ComboBox cmbProduct 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_PO_PurchaseOrderByProduct.frx":0028
         Left            =   1320
         List            =   "RPT_PO_PurchaseOrderByProduct.frx":002A
         TabIndex        =   7
         Top             =   720
         Width           =   2415
      End
      ...
      Begin VB.ComboBox cmbCategory 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_PO_PurchaseOrderByProduct.frx":002C
         Left            =   1320
         List            =   "RPT_PO_PurchaseOrderByProduct.frx":002E
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   1080
         Width           =   2415
      ...
      Begin VB.ComboBox cmbSupplier 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_PO_PurchaseOrderByProduct.frx":0030
         Left            =   1320
         List            =   "RPT_PO_PurchaseOrderByProduct.frx":0032
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   1440
         Width           =   2415
      ...
      Begin VB.ComboBox cmbGroup 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_PO_PurchaseOrderByProduct.frx":0034
         Left            =   1320
         List            =   "RPT_PO_PurchaseOrderByProduct.frx":0041
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   3720
         Visible         =   0   'False
...
Private Sub btnGenerate_Click()
    ...
    Select Case cmbGroup.ListIndex
        Case 0 ' normal
            Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\PO_PurchaseOrderByProduct.rpt")
        Case 1 ' supplier
