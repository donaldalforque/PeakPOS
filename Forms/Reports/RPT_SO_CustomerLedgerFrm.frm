...
Begin VB.Form RPT_SO_CustomerLedgerFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CustomerLedgerFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SO_CustomerLedgerFrm.frx":000A
         TabIndex        =   3
         Text            =   "cmbCustomer"
         Top             =   600
         Width           =   2415
   ...
   End
End
Attribute VB_Name = "RPT_SO_CustomerLedgerFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.path & "\Reports\SO_CustomerLedger.rpt")
