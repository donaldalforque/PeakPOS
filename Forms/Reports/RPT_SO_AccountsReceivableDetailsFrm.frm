...
Begin VB.Form RPT_SO_InvoiceTransactionsFrm 
   Caption         =   "Customer Invoice Transactions"
   ClientHeight    =   9015
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15090
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSort 
         ...
         Left            =   1320
         List            =   "RPT_SO_AccountsReceivableDetailsFrm.frx":0016
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_AccountsReceivableDetailsFrm.frx":004C
         Left            =   1320
         List            =   "RPT_SO_AccountsReceivableDetailsFrm.frx":0056
         TabIndex        =   2
         Top             =   720
         Width           =   2415
      End
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\SO_CustomerInvoiceTransactions.rpt")
