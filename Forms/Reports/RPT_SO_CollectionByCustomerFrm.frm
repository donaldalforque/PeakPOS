...
Begin VB.Form RPT_SO_CollectionByCustomerFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSort 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CollectionByCustomerFrm.frx":0000
         Left            =   1320
         List            =   "RPT_SO_CollectionByCustomerFrm.frx":000D
      ...
      Begin VB.ComboBox cmbCustomer 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "RPT_SO_CollectionByCustomerFrm.frx":003A
         Left            =   1320
         List            =   "RPT_SO_CollectionByCustomerFrm.frx":0044
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   5640
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "RPT_SO_CollectionByCustomerFrm"
...
Private Sub btnGenerate_Click()
    ...
    Set crxRpt = crxApp.OpenReport(App.Path & "\Reports\SO_CollectionByCustomer.rpt")
