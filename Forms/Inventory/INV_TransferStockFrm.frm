...
Begin VB.Form INV_TransferStockFrm 
   ...
   Begin VB.PictureBox picPaid 
      ...
      Height          =   1860
      Left            =   -9960
      Picture         =   "INV_TransferStockFrm.frx":212C0
      ScaleHeight     =   1860
      ScaleWidth      =   5250
      TabIndex        =   0
      Top             =   2640
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":2A251
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":30AB3
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":37315
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":3DB77
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":3DDEC
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "INV_TransferStockFrm.frx":3E45D
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Public currentproductid As Long
...
Private Sub Save(ByVal StatusId As Integer, Optional isReopen As Variant)
    If Validated = True Then
        ...
        cmd.Parameters.Append cmd.CreateParameter("@WarehouseManagerId", adInteger, adParamInput, , cmbWarehouseManager.ItemData(cmbWarehouseManager.ListIndex))
        ...
        If TransferStockId = 0 Then
            ...
            SavePOSAuditTrail UserId, WorkstationId, "", "Created new transfer stock order: " & txtOrderNumber.Text & " with ORIGIN: " & cmbOrigin.Text & " and DEST.: " & cmbDestination.Text, "INVENTORY"
        Else
            ...
            SavePOSAuditTrail UserId, WorkstationId, "", "Updated transfer stock order: " & txtOrderNumber.Text & " - Status: " & auditstatus, "INVENTORY"
        End If
        ...
        For Each item In lvItems.ListItems
            If AllowNegativeInventory = False Then
                ...
                cmd.CommandType = adCmdStoredProc
                cmd.Parameters.Append cmd.CreateParameter("@ReserveId", adInteger, adParamInput, , Val(item.SubItems(9)))
                cmd.Parameters.Append cmd.CreateParameter("@ModuleId", adInteger, adParamInput, , 4)
                cmd.Parameters.Append cmd.CreateParameter("@Id", adInteger, adParamInput, , TransferStockId)
        ...
        Case "TransferStockGet"
            ...
            If Not rec.EOF Then
                'If rec!isCashAdvance = "False" Then
                    ...
                    cmbWarehouseManager.Text = rec!WarehouseManager
                    ...
                    On Error Resume Next
                    cmbOrigin.Text = rec!fromlocation
                    cmbDestination.Text = rec!tolocation
...
Private Sub btnItemSearch_Click()
    ...
    cmd.ActiveConnection = con
    cmd.CommandType = adCmdStoredProc
    cmd.CommandText = "BASE_ProductSearch_TS"
    cmd.Parameters.Append cmd.CreateParameter("@Name", adVarChar, adParamInput, 500, txtItemSearch.Text)
    cmd.Parameters.Append cmd.CreateParameter("@LocationId", adInteger, adParamInput, , cmbOrigin.ItemData(cmbOrigin.ListIndex))
...
Private Sub Form_Load()
    ...
    lvItemList.ColumnHeaders(3).width = lvItemList.width * 0.6499
    lvItemList.ColumnHeaders(4).width = lvItemList.width * 0.1533
    lvItemList.ColumnHeaders(5).width = lvItemList.width * 0
    lvItemList.ColumnHeaders(6).width = lvItemList.width * 0
    lvItemList.ColumnHeaders(7).width = lvItemList.width * 0
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    DeleteReserves WorkstationId, 4
End Sub
...
Private Sub lvItemList_DblClick()
    ...
    If lvItemList.ListItems.count > 0 Then
        ...
        INV_TransferStockOptFrm.lblAvailable.Caption = lvItemList.SelectedItem.SubItems(4)
        INV_TransferStockOptFrm.Show (1)
        currentproductid = lvItemList.SelectedItem.Text
    End If
End Sub
        ...
        Case vbKeyDelete
            If lvItems.ListItems.count > 0 Then
                If lvItems.SelectedItem.Text <> "" Then
                    ...
                    DeleteReserveLine lvItems.SelectedItem.SubItems(9)
                    
                    SavePOSAuditTrail UserId, WorkstationId, "", "Removed item: " & lvItems.SelectedItem.SubItems(3) & " from transfer stock order: " & txtOrderNumber.Text
...
Private Sub tb_Standard_ButtonClick(ByVal Button As MSComctlLib.Button)
    If EditAccessRights(7) = False Then
    ...
    Select Case Button.Index
        ...
        Case 4 'Cancel
            ...
            If TransferStockId <> 0 Then
                ...
                ElseIf StatusId = 2 Then
                    MsgBox "Cannot cancel a completed order.", vbCritical
                End If
                LoadImageStatus picStatus, GetStatus(StatusId)
            End If
        Case 6 'PRINT PREVIEW
            If TransferStockId <> 0 Then
                ...
                crxRpt.DiscardSavedData
                crxRpt.RecordSelectionFormula = "{INV_TransferStock.TransferStockId}= " & TransferStockId & ""
                crxRpt.ParameterFields.GetItemByName("FromLocation").AddCurrentValue cmbOrigin.Text
                crxRpt.ParameterFields.GetItemByName("ToLocation").AddCurrentValue cmbDestination.Text
                ...
                SavePOSAuditTrail UserId, WorkstationId, "", "Generated print preview on transfer stock order: " & txtOrderNumber.Text, "INVENTORY"
            End If
    End Select
End Sub
